r"""
CSP screener backtest CLI — thin wrapper around `services.csp_backtest_service`.

The engine lives in `backend/services/csp_backtest_service.py` so the API
endpoint and this script share exactly one implementation. See ADR-0031 for
...
from services.csp_backtest_service import (  # noqa: E402
    DEFAULT_DTE,
    DEFAULT_RF,
    DEFAULT_WEEKLY_STEP,
    SCORE_BUCKETS,
