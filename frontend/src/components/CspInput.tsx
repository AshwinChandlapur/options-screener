...
const SCORE_LEGEND = [
  ...
  { factor: 'IV Percentile',   weight: 35,  detail: '<30th=0 · 30–50th→0→10 · 50–75th→10→25 · 75–90th→25→35 · ≥90th=35. HV-derived — never stale.',
    ...
    why: 'Regime-agnostic: a stable stock (AAPL, KO) during its own elevated-IV period scores well even if its absolute IV/HV ratio is near 1.0. The old IV/HV ratio structurally favoured high-beta names (NVDA, TSLA) because their elevated realized vol kept the ratio low during calm periods. IV percentile removes that bias.',
