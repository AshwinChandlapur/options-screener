 ...
 *
 * Stage 4 is intentionally absent: the detector skips it in hysteresis
 * (apply_hysteresis snaps a 3 → 5 transition over 4) because there is no
 * deterministic signal-side rule that targets it. Any stale doc with
 * stage == 4 will fall through to the STAGE_META[0] placeholder ("…")
 * and clear within the next detector cycle. See Quant audit MEDIUM #8.
 */
